using LibraryManagementSystem.Core.Extensions;
...
namespace LibraryManagementSystem.DataAccess.DALS.Base
{
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class, IEntity, new()
    {
        ...
        {
            return _context.Set<TEntity>().MultipleInclude(includes).FirstOrDefault(filter);
        }
        ...
        {
            return filter == null ? _context.Set<TEntity>().MultipleInclude(includes).Select(selector) :
